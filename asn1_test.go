...
func TestAsn1_encode_AARQapdu_1_for_tcp_meter(t *testing.T) {
	t.Logf("TestAsn1_encode_AARQapdu_1_for_tcp_meter()")
	/*
	...
	*/
	...
	err := encode_AARQapdu_1(&buf, &aarq)
	if nil != err {
		t.Fatalf("encode_AARQapdu() failed")
	}
	b := buf.Bytes()
...
func TestAsn1_decode_AARQapdu_1_for_tcp_meter(t *testing.T) {
	t.Logf("TestAsn1_decode_AARQapdu_1_for_tcp_meter()")
	/*
	...
	*/
	...
	err, aarq := decode_AARQapdu_1(buf)
	if nil != err {
...
func TestAsn1_encode_AARQapdu_1_for_hdlc_meter(t *testing.T) {
	t.Logf("TestAsn1_encode_AARQapdu_1_for_hdlc_meter()")
	/*
